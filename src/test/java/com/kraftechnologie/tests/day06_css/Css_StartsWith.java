...
public class Css_StartsWith {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //Fourth formula
        //[attribute^='first part of value']
        //tagname[attribute^='first part of value']
        ...
        WebElement doNotHaveAnAccount=driver.findElement(By.cssSelector("[class^='sm']"));
        System.out.println(doNotHaveAnAccount.getText());
