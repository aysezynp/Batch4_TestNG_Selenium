...
public class DisabledElement {
    ...
    public void disabledElement() throws InterruptedException {
        ...
        WebElement disebledElement = driver.findElement(By.cssSelector("#input-example>input"));
        Assert.assertFalse(disebledElement.isEnabled(),"Verify that element is NOT enable or disable");
        ...
        Assert.assertTrue(disebledElement.isEnabled());
        Thread.sleep(2000);
